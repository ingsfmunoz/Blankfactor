Feature: Accept Policy on BlankFactor Website
  ...
  Scenario: registers on the Become a Client form
    ...
    When the user enters "Tester Testing" in the first name field
    And the user enters "Tester Testing" in the last name field
    And the user enters "Tester Testing" in the company field
    And the user enters "tester_testing@gmail.com" in the email field
    And the the user enters "317892345" in the phone field
    And the user enters "Tester Testing" in the project field
